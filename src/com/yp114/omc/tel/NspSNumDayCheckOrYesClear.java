...
public class NspSNumDayCheckOrYesClear extends Configured implements Tool {
	public static void main(String args[]){
		try {
			ToolRunner.run(new NspSNumDayCheckOrYesClear(), args);
		} catch (Exception e) {
	...
	conf.set("dfs.client.block.write.replace-datanode-on-failure.enable",
		...
		Job job = Job.getInstance(conf, "NspSNumDayCheckOrYesClear");
		job.setJarByClass(NspSNumDayCheckOrYesClear.class);
    ...
    public static class CombineMapper extends Mapper<Object,Text,Text,IntWritable>{
    	public void map(Object key,Text value,Context context) throws IOException, InterruptedException{
			...
			word.set(regioncode + "#r#" + requestType + "#y#" + yesOrNo);
