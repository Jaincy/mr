...
public class HotTelTotalProcessor extends Configured implements Tool{
	
	
	public static void main(String[] args) {
		try {
			ToolRunner.run(new HotTelTotalProcessor(), args);
		} catch (Exception e) {
	...
	public int run(String[] args) throws Exception {
		...
		Job job =Job.getInstance(conf, "HotTelTotalProcessor");
		job.setJarByClass(HotTelTotalProcessor.class);
		job.setMapperClass(HotTotalMapper.class);
		job.setCombinerClass(HotTotalReducer.class);
		job.setReducerClass(HotTotalReducer.class);
	...
	public static class HotTotalMapper  extends Mapper<Object, Text, IntPair, IntWritable>{
	...
	public static class HotTotalReducer extends Reducer<IntPair, IntWritable, Text, IntWritable>{
		@Override
