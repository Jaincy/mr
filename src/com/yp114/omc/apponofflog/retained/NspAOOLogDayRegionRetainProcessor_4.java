...
public class NspAOOLogDayRegionRetainProcessor_4 extends Configured implements Tool{

	//4，合并上两步的结果  ， 相同key 中 做除运算
	public static void main(String[] args) {
		try {
			ToolRunner.run(new NspAOOLogDayRegionRetainProcessor_4(), args);
		} catch (Exception e) {
	...
	public int run(String[] args) throws Exception {
		...
		Job job = Job.getInstance(conf, "NspAOOLogDayRegionRetainProcessor_4");
		job.setJarByClass(NspAOOLogDayRegionRetainProcessor_4.class);
		job.setMapperClass(AOODayRegionMapper_4.class);
		job.setReducerClass(AOODayRegionReducer_4.class);
...
//		  job.setOutputValueClass(IntWritable.class);
	...
	public static class AOODayRegionMapper_4 extends Mapper<Object, Text, Text, Text>{
		@Override
	...
	public static class AOODayRegionReducer_4 extends Reducer<Text, Text, Text, Text>{
