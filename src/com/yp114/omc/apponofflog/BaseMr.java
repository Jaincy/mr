...
public class BaseMr {
    ...
    public Map getSubMap() {
        ...
        String min_id = "nomin_id";
        String sec_id = "nosec_id";
        if (time.length() > 9) {
        ...
        //custName
        String custName = "nocustName";
        if (requesttype.equals("64")) {
            custName = sub("custName");
        } else if (requesttype.equals("63")) {
            if (!sub("name").equals("naname")) {
                custName = sub("name");
            }
