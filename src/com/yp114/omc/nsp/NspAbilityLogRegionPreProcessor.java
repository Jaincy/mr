...
public class NspAbilityLogRegionPreProcessor extends Configured implements Tool{
	/*
	...
	public static void main(String[] args) {
		try {
			ToolRunner.run(new NspAbilityLogRegionPreProcessor(), args);
		} catch (Exception e) {
	...
	public int run(String[] args) throws Exception {
		// TODO Auto-generated method stub
		 ...
		 Job job =Job.getInstance(conf, "NspAbilityLogRegionPreProcessor");
		 job.setJarByClass(NspAbilityLogRegionPreProcessor.class);
		 FileInputFormat.addInputPath(job, new Path(args[0]));
		 FileOutputFormat.setOutputPath(job, new Path(args[1]));
		 
		 job.setMapperClass(NspLogRegionPreMapper.class);
		 job.setCombinerClass(NspLogRegionPreReducer.class);
		 job.setReducerClass(NspLogRegionPreReducer.class);
	...
	public static class NspLogRegionPreMapper extends Mapper<Object, Text, Text, IntWritable>{
	...
	public static class NspLogRegionPreReducer extends Reducer<Text, IntWritable, Text, IntWritable>{
