...
public class AppO2oLogProcessorTotalPre extends Configured implements Tool {
	...
	public static void main(String[] args) {
		...
		try {
			ToolRunner.run(new Configuration(), new AppO2oLogProcessorTotalPre(),
					args);
		} catch (Exception e) {
		}
	}
	...
	public int run(String[] args) throws Exception {
		...
		job.setJarByClass(AppO2oLogProcessorTotalPre.class);
